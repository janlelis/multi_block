...
Gem::Specification.new do |s|
  ...
  s.files = Dir.glob %w{multi_block.gemspec lib/multi_block.rb lib/multi_block/version.rb lib/multi_block/implementation.rb lib/multi_block/core_ext.rb spec/multi_block_spec.rb}
